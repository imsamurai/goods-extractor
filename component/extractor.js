...
extRequire(__dirname+'/../lib/utility/field/fieldset_builder.js');
extRequire(__dirname+'/../lib/utility/field/field_group.js');
extRequire(__dirname+'/../lib/utility/field/fields_visualizer.js');
extRequire(__dirname+'/../lib/filter/fields_filter.js');
extRequire(__dirname+'/../lib/utility/neural/product_model.js');
extRequire(__dirname+'/../lib/data/neural/dict.js');
extRequire(__dirname+'/../lib/data/neural/product.js');
...
exports.getProductNeural = getProductNeural;
exports.Dict = new Dict;
exports.brain = require("brain");