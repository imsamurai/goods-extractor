 ...
 */
function ProductModel(element, value, dic) {
    ...
    this.getLabeledSample = function(labels) {
        return {
    ...
    function construct() {
        ...
        addProp('tag',  'normalizedLength', getNormalizedLength(value, 100));
    ...
    function getNormalizedLength(val, maxlen) {
