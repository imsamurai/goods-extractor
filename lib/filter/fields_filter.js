    ...
    this.run = function() {
        ...
        for (var posName = 0;posName<fieldNames.length;posName++) {
            ...
            if (
                ...
                var rateSum = data.data[fieldNames[posName]].filter(function(field) {return field.type==bestType;}).reduce(function(acc, field) { return acc + field.typeRate; }, 0) / data.data[fieldNames[posName]].length;
